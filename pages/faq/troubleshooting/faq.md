...
All devices in your application will share the same code base, so if you mix device types you'll want to be sure that you define an architecture-specific base image.
